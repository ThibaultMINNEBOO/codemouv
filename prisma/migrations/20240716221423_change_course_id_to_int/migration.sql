/*
  ...
  - Changed the type of `A` on the `_CourseToTag` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
-- AlterTable
ALTER TABLE "_CourseToTag" DROP COLUMN "A",
